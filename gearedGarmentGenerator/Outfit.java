...
public class Outfit
{
    ...
    public String displayOutfit()
    {
        ...
        else
        {
            if (top != null)
            {
                builder.append("Top: ").append(top.getDescription())
                    .append("\n");
            }
            if (bottom != null)
            {
                builder.append("Bottom: ").append(bottom.getDescription())
                    .append("\n");
            }
        }
        if (jacket != null)
        {
            builder.append("Jacket: ").append(jacket.getDescription())
                .append("\n");
        }
        if (shoes != null)
        {
            builder.append("Shoes: ").append(shoes.getDescription())
                .append("\n");
